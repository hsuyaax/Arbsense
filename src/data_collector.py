...
def build_sample_markets() -> list[dict[str, Any]]:
    ...
    return [
        _market(
            "predict.fun",
            "pf-ct26-india",
            "Will India win ICC Champions Trophy 2026?",
            "Resolves YES if India is the official winner of ICC Champions Trophy 2026.",
            0.62,
            0.38,
            18000,
            16000,
        ...
        _market(
            "probable",
            "pr-icc-ct26-india",
            "ICC CT26 Winner - India",
            "YES resolves if India lifts the ICC Champions Trophy 2026 title.",
            0.54,
            0.46,
            14000,
            13000,
        ...
        _market(
            "XO Market",
            "xo-btc-150k-q3",
            "BTC above 150k before Q3 2026?",
            "YES resolves if BTC spot price exceeds 150,000 USD prior to July 1, 2026 UTC.",
            0.47,
            0.53,
            22000,
            20000,
        ...
        _market(
            ...
            "Will Bitcoin cross $150,000 by July 2026?",
            "Resolves to YES when Bitcoin trades above $150,000 before July 2026 cutoff.",
            0.40,
            0.60,
            15500,
            15000,
        ...
        _market(
            "Bento",
            "be-eth-7k-2026",
            "ETH to hit $7,000 in 2026?",
            "YES resolves if ETH/USD reaches 7000 any time before Dec 31, 2026.",
            0.33,
            0.67,
            12000,
            12500,
        ...
        _market(
            "predict.fun",
            "pf-eth-7000-2026",
            "Ethereum above 7k by end of 2026?",
            "YES if Ether spot price prints above $7,000 before 2027.",
            0.39,
            0.61,
            15000,
            14500,
        ...
        _market(
            "probable",
            "pr-sol-etf-2026",
            "Will a US SOL ETF be approved in 2026?",
            "Resolves YES if a spot Solana ETF is approved by a US regulator by Dec 31, 2026.",
            0.29,
            0.71,
            6000,
            7000,
        ...
        _market(
            "XO Market",
            "xo-solana-etf-2026",
            "Spot Solana ETF approval by end-2026?",
            "YES if US authorities approve a spot SOL ETF before 2027.",
            0.36,
            0.64,
            9200,
            9100,
        ...
        _market(
            ...
            "YES if FOMC delivers at least one cut by Sep 30, 2026.",
            0.58,
            0.42,
            11000,
            10800,
        ...
        _market(
            "Bento",
            "be-us-rates-cut-q3",
            "US policy rate lower by Q3 2026?",
            "YES resolves if benchmark US policy rate is lower by end of Q3 2026 than Jan 1 level.",
            0.51,
            0.49,
            9000,
            9200,
        ...
        _market(
            ...
            "YES resolves when spot gold prints 3000+ in 2026.",
            0.49,
            0.51,
            8600,
            8500,
        ...
        _market(
            "XO Market",
            "xo-ai-act-passed",
            "EU AI Act fully effective by 2026?",
            "YES if core AI Act obligations are enforceable before Dec 31, 2026.",
            0.43,
            0.57,
            4500,
            4700,
        ...
        _market(
            "Opinion",
            "op-eu-ai-law-active",
            "Will EU AI law become enforceable in 2026?",
            "YES if EU AI regulation enforcement begins within 2026.",
            0.38,
            0.62,
            5100,
            5000,
        ...
        _market(
            "Bento",
            "be-nvidia-2t-q2",
            "NVIDIA market cap > $2T by Q2 2026?",
            "YES if NVDA reaches a market capitalization above 2 trillion USD by Jun 30, 2026.",
            0.57,
            0.43,
            9700,
            9600,
        ...
        _market(
            "predict.fun",
            "pf-nvda-2trn-june",
            "Will NVDA exceed $2 trillion by June 2026?",
            "YES if NVIDIA valuation passes 2T before July 2026.",
            0.61,
            0.39,
            10200,
            10100,
